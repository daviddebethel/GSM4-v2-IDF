...
assert_has "CONFIG_ESPTOOLPY_FLASHSIZE_16MB=y" "${release_sdkconfig}"
assert_has "CONFIG_PARTITION_TABLE_CUSTOM=y" "${release_sdkconfig}"
assert_has "CONFIG_PARTITION_TABLE_FILENAME=\"partitions_16mb.csv\"" "${release_sdkconfig}"
